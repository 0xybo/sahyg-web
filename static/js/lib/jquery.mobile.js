	...
	!(function (a) {
		...
		(function (a, b) {
			function d(b, c) {
				...
				return "area" === h
					? ((d = b.parentNode),
					  (f = d.name),
					  b.href && f && "map" === d.nodeName.toLowerCase() ? ((g = a("img[usemap=#" + f + "]")[0]), !!g && e(g)) : !1)
									...
									? this.parents()
											.filter(function () {
												return (
													...
													/(auto|scroll)/.test(
														a.css(this, "overflow") + a.css(this, "overflow-y") + a.css(this, "overflow-x")
													)
												);
											})
											.eq(0)
			...
			a.extend(a.mobile, {
				...
				removeActiveLinkClass: function (b) {
					!a.mobile.activeClickedLink ||
						(a.mobile.activeClickedLink.closest("." + a.mobile.activePageClass).length && !b) ||
						...
						for (e in g[h])
							(f = g[h][e]),
								g[h].hasOwnProperty(e) &&
									f !== b &&
									(c[e] = a.isPlainObject(f) ? (a.isPlainObject(c[e]) ? a.widget.extend({}, c[e], f) : a.widget.extend({}, f)) : f);
					return c;
				}),
		...
		(function (a, b, c) {
			...
			a.extend(a.mobile, {
				...
				(a.fn.jqmData = function (b, d) {
					...
					return (
						"undefined" != typeof b &&
							(b && (b = a.mobile.nsNormalize(b)), (e = arguments.length < 2 || d === c ? this.data(b) : this.data(b, d))),
						e
					);
				}),
			...
			function f() {
				var c = b,
					d = !(
						...
						!c.document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect ||
			...
			(a.mobile.path = d =
				{
					...
					makePathAbsolute: function (a, b) {
						...
						for (
							a = a || "", b = b ? b.replace(/^\/|(\/[^\/]*|[^\/]+)$/g, "") : "", c = b ? b.split("/") : [], d = a.split("/"), e = 0;
							e < d.length;
							e++
						)
							switch ((f = d[e])) {
					...
					isFirstPageUrl: function (b) {
						var e = d.parseUrl(d.makeUrlAbsolute(b, this.documentBase)),
							f =
								...
								(this.documentBaseDiffers && e.hrefNoHash === this.documentBase.hrefNoHash),
				...
				a.extend(a.mobile.History.prototype, {
					...
					find: function (a, b, c) {
						...
						for (e = 0; g > e; e++)
							if (
								((d = b[e]),
								(decodeURIComponent(a) === decodeURIComponent(d.url) || decodeURIComponent(a) === decodeURIComponent(d.hash)) &&
									((f = e), c))
							)
								return f;
						return f;
			...
			a.each(["animation", "transition"], function (c, g) {
				...
				(a.fn.animationComplete = function (e, f, g) {
					...
					return (a.support.cssTransitions && "transition" === l) || (a.support.cssAnimations && "animation" === l)
						? (g === b &&
								(a(this).context !== c && (i = 3e3 * parseFloat(a(this).css(d[l].duration))),
		...
		(function (a, b, c, d) {
			...
			function f(b, c) {
				...
				if (
					...
					-1 !== o.search(/^touch/) &&
						((h = e(f)), (o = h.touches), (j = h.changedTouches), (k = o && o.length ? o[0] : j && j.length ? j[0] : d)))
				)
					...
					o("vmouseup", a, d),
						J ||
							...
							b &&
								...
								((c = e(a).changedTouches[0]), K.push({ touchID: Q, x: c.clientX, y: c.clientY }), (L = !0))),
						o("vmouseout", a, d),
						(J = !1),
						m();
				}
				...
				(a.event.special.swipe = {
					...
					handleSwipe: function (b, c, d, f) {
						if (
							...
							return (
								e(d, "swipe", a.Event("swipe", { target: f, swipestart: b, swipestop: c }), !0),
								...
								if (!a.event.special.swipe.eventInProgress) {
									...
									(e.move = function (b) {
										g &&
											...
											Math.abs(g.coords[0] - d.coords[0]) > a.event.special.swipe.scrollSupressionThreshold &&
												b.preventDefault());
									}),
										(e.stop = function () {
				...
				(a.event.special.orientationchange.orientation = e =
					function () {
						var d = !0,
							e = c.documentElement;
						return (
							(d = a.support.orientation ? n[b.orientation] : e && e.clientWidth / e.clientHeight < 1.1), d ? "portrait" : "landscape"
						);
					}),
				(a.fn[m] = function (a) {
				...
				c = {
					...
					set: function (b) {
						a.mobile.dynamicBaseEnabled &&
							...
							c.element.attr("href", a.mobile.path.makeUrlAbsolute(b, a.mobile.path.documentBase));
					},
		...
		(function (a, b) {
			...
			(a.widget = (function (c) {
				return function () {
					...
					return (
						(d.initSelector = d.prototype.initSelector !== b ? d.prototype.initSelector : ":jqmData(role='" + e + "')"),
			...
			a.widget("mobile.pagecontainer", {
				...
				_handleNavigate: function (b, c) {
					...
					a.extend(g, c, { transition: f }),
						(e.activeIndex > 0 && d.indexOf(a.mobile.dialogHashKey) > -1 && ((d = this._handleDialog(g, c)), d === !1)) ||
				...
				_loadSuccess: function (b, c, e, f) {
					...
					return a.proxy(function (h, i, j) {
						...
						l.test(h) &&
							...
							m.test(RegExp.$1) &&
							RegExp.$1 &&
							((g = a.mobile.path.getFilePath(a("<div>" + RegExp.$1 + "</div>").text())), (g = this.window[0].encodeURIComponent(g))),
				...
				load: function (b, c) {
					...
					return (
						k.data && "get" === k.type && ((m = a.mobile.path.addSearchParams(m, k.data)), (k.data = d)),
						k.data && "post" === k.type && (k.reload = !0),
						(e = this._createFileUrl(m)),
						(f = this._createDataUrl(m)),
						(l = this._find(m)),
						0 === l.length && a.mobile.path.isEmbeddedPage(e) && !a.mobile.path.isFirstPageUrl(e)
							? (i.reject(m, k), i.promise())
							: (this._getBase().reset(),
							  l.length && !k.reload
									? (this._enhance(l, k.role), i.resolve(m, k, l), k.prefetch || this._getBase().set(b), i.promise())
									: ((h = { url: b, absUrl: m, toPage: b, prevPage: c ? c.fromPage : d, dataUrl: f, deferred: i, options: k }),
									  ...
									  g.deprecatedEvent.isDefaultPrevented() || g.event.isDefaultPrevented()
											...
											: (k.showLoadMsg && this._showLoading(k.loadMsgDelay),
											  ...
											  a.mobile.allowCrossDomainPages || a.mobile.path.isSameDomain(a.mobile.path.documentUrl, m)
													? (a.ajax({
															url: e,
															type: k.type,
															data: k.data,
				...
				_triggerCssTransitionEvents: function (b, c, d) {
					...
					(d = d || ""),
						c &&
							(b[0] === c[0] && (e = !0),
							this._triggerWithDeprecated(d + "hide", { nextPage: b, toPage: b, prevPage: c, samePage: e }, c)),
				...
				change: function (b, c) {
					...
					(d.fromPage = d.fromPage || this.activePage),
						this._triggerPageBeforeChange(b, g, d) &&
							((b = g.toPage), "string" === a.type(b) ? ((f = !0), this._loadUrl(b, g, d)) : this.transition(b, g, d));
				},
					...
					if (
						...
						if (
							...
							return (
								...
								void (h.fromHashChange && a.mobile.navigate.history.direct({ url: j }))
							);
						...
						(r = !1),
							...
							(h.transition =
								h.transition ||
								(o && !n ? m.transition : d) ||
								(q ? a.mobile.defaultDialogTransition : a.mobile.defaultPageTransition)),
							...
							j &&
								...
								h.changeHash !== !1 && a.mobile.hashListeningEnabled
									...
									: b[0] !== a.mobile.firstPage[0] && a.mobile.navigate.history.add(j, t)),
							(c.title = p),
					...
					a.mobile.document.delegate("form", "submit", function (b) {
						...
						a.mobile.document.bind("click", function (c) {
							if (a.mobile.linkBindingEnabled && !c.isDefaultPrevented()) {
								...
								if (
									(a.mobile.activeClickedLink && a.mobile.activeClickedLink[0] === c.target.parentNode && p(),
		...
		(function (a, b, c) {
			a.widget("mobile.page", a.mobile.page, {
				...
				_create: function () {
					this._super(),
						this.options.dialog &&
							(a.extend(this, { _inner: this.element.children(), _headerCloseButton: null }),
				...
				_handlePageBeforeShow: function () {
					this.options.overlayTheme && this.options.dialog
						? (this.removeContainerBackground(), this.setContainerBackground(this.options.overlayTheme))
						: this._super();
				},
			...
			a.widget("mobile.dialog", {
				...
				_handleVClickSubmit: function (b) {
					...
					d.length &&
						...
						(c["data-" + a.mobile.ns + "transition"] =
							(a.mobile.navigate.history.getActive() || {}).transition || a.mobile.defaultDialogTransition),
				...
				_create: function () {
					...
					b
						.addClass("ui-dialog")
						.wrapInner(
							a("<div/>", { role: "dialog", class: "ui-dialog-contain ui-overlay-shadow" + (c.corners ? " ui-corner-all" : "") })
						),
							...
							h &&
								l.addClass(
									[d(n.iconpos !== b ? n.iconpos : j.iconpos)]
										.concat(
											c
												? ["ui-icon-" + (n.collapsedIcon !== b ? n.collapsedIcon : j.collapsedIcon)]
												: ["ui-icon-" + (n.expandedIcon !== b ? n.expandedIcon : j.expandedIcon)]
										)
										.join(" ")
								)),
						n.theme !== b &&
				...
				a.extend(
					{
						...
						_handleCollapsibleExpand: function (b) {
							...
							c.parent().is(":mobile-collapsibleset, :jqmData(role='collapsible-set')") &&
								c.siblings(".ui-collapsible:not(.ui-collapsible-collapsed)").collapsible("collapse");
						},
						_create: function () {
							var b = this.element,
								c = this.options;
								...
								(d = a(this._findFirstElementByTagName(b[c].firstChild, "nextSibling", "img", "IMG"))),
									d.length &&
										a(this._findFirstElementByTagName(d[0].parentNode, "parentNode", "li", "LI")).addClass(
											d.hasClass("ui-li-icon") ? "ui-li-has-icon" : "ui-li-has-thumb"
										);
						},
				...
				_afterListviewRefresh: function () {
					...
					if ((this._superApply(arguments), this.options.hideDividers))
						for (a = this._getChildrenByTagName(this.element[0], "li", "LI"), d = a.length - 1; d > -1; d--)
							(e = a[d]),
								e.className.match(b)
									? (f && (e.className = e.className + " ui-screen-hidden"), (f = !0))
				...
				a.extend(
					{
						...
						_enhance: function () {
							this.label.addClass("ui-btn ui-corner-all"),
								this.labelIsParent
									...
									: (this.element.wrap(this._wrapper()), this.element.parent().prepend(this.label)),
						...
						_hasIcon: function () {
							...
							return d && ((b = this.element.closest(":mobile-controlgroup," + d.prototype.initSelector)), b.length > 0)
								? ((c = a.data(b[0], "mobile-controlgroup")),
								  "horizontal" !== (c ? c.options.type : b.attr("data-" + a.mobile.ns + "type")))
								: !0;
						},
						refresh: function () {
						...
						_setOptions: function (a) {
							...
							a.disabled !== b && (this.input.prop("disabled", !!a.disabled), e.toggleClass("ui-state-disabled", !!a.disabled)),
								...
								a.iconpos !== b && f
									? c.removeClass("ui-btn-icon-" + d.iconpos).addClass("ui-btn-icon-" + a.iconpos)
				...
				_setOptions: function (c) {
					...
					c.theme !== b && d.removeClass(this.options.theme).addClass("ui-btn-" + c.theme),
						...
						(c.icon !== b || c.iconshadow !== b || c.iconpos !== b) &&
							d.removeClass(this._getIconClasses(this.options)).addClass(this._getIconClasses(a.extend({}, this.options, c))),
						this._super(c);
				},
				refresh: function (b) {
					var c,
		...
		(function (a, b) {
			a.widget("mobile.textinput", {
				...
				_wrap: function () {
					return a(
						"<div class='" + (this.isSearch ? "ui-input-search " : "ui-input-text ") + this.classes.join(" ") + " ui-shadow-inset'></div>"
					);
				},
				...
				a.extend(
					{
						...
						_create: function () {
							...
							p.addClass(v ? "ui-slider-switch" : "ui-slider-input"),
								...
								v ||
									w ||
									((f = this.options.mini ? "<div class='ui-slider ui-mini'>" : "<div class='ui-slider'>"), p.add(H).wrapAll(f)),
						...
						refresh: function (b, d, e) {
							...
							if (
								...
								if (
									((y = !1),
									m ? ((y = parseFloat(l.val()) !== r), l.val(r)) : ((y = l[0].selectedIndex !== r), (l[0].selectedIndex = r)),
						...
						_setHighlight: function (a) {
							(a = !!a),
								a ? ((this.options.highlight = !!a), this.refresh()) : this.valuebg && (this.valuebg.remove(), (this.valuebg = !1));
						},
						...
						_setMini: function (a) {
							(a = !!a),
								this.isToggleSwitch ||
									this.isRangeslider ||
									(this.slider.parent().toggleClass("ui-mini", a), this.element.toggleClass("ui-mini", a)),
				...
				_refresh: function () {
					...
					b.popupEnabled && this.handle.removeAttr("title"),
						...
						a !== this._currentValue &&
							...
							b.popupEnabled && this._popup && (this._positionPopup(), this._popup.html(a)),
							b.showValue && !this.options.mini && this.handle.html(a));
				},
				_showPopup: function () {
					this.options.popupEnabled &&
						!this._popupVisible &&
						(this.handle.html(""), this._popup.show(), this._positionPopup(), (this._popupVisible = !0));
				},
				_hidePopup: function () {
					var a = this.options;
					a.popupEnabled &&
						this._popupVisible &&
						(a.showValue && !a.mini && this.handle.html(this._value()), this._popup.hide(), (this._popupVisible = !1));
				},
			});
		})(a),
		(function (a, b) {
				...
				a.extend(
					{
						...
						_keydown: function (b) {
							b.which === a.mobile.keyCode.LEFT
								...
								? this._right()
								: b.which === a.mobile.keyCode.SPACE && (this._toggle(), b.preventDefault());
						},
						_setOptions: function (a) {
							if (a.theme !== b) {
						...
						_slidedrag: function (b) {
							...
							return (
								...
								("first" === this._proxy && c) || ("last" === this._proxy && !c)
									? ((a.data(d.get(0), "mobile-slider").dragging = !0), a.data(d.get(0), "mobile-slider").refresh(b), !1)
									: void 0
							);
						},
			...
			a.widget("mobile.popup", {
				...
				_setOptions: function (a) {
					...
					return (
						...
						a.theme !== c &&
							d.removeClass(this._themeClassFromOption("ui-body-", b.theme)).addClass(this._themeClassFromOption("ui-body-", a.theme)),
						a.overlayTheme !== c &&
							(e
			...
			a.widget("mobile.selectmenu", a.mobile.selectmenu, {
				...
				_handleListItemClick: function (b) {
					...
					(f.selected = this.isMultiple ? !f.selected : !0),
						...
						this.isMultiple
							? (this.select.trigger("change"), this.list.find("li:not(.ui-li-divider)").eq(e).find("a").first().focus())
							: this.close(),
						b.preventDefault();
				},
				build: function () {
					...
					return v.nativeMenu
						...
						: ((c = this.selectId),
						  ...
						  this._origTabIndex === b &&
								(this._origTabIndex = null === this.select[0].getAttribute("tabindex") ? !1 : this.select.attr("tabindex")),
				...
				_buildList: function () {
					var b,
						...
						B = !1;
					for (
						q.list.empty().filter(".ui-listview").listview("destroy"), b = this._selectOptions(), d = b.length, e = this.select[0], g = 0;
						d > g;
						g++, B = !1
					)
						(h = b[g]),
				...
				_button: function () {
					return this.options.nativeMenu
						? this._super()
						: a("<a>", { href: "#", role: "button", id: this.buttonId, "aria-haspopup": "true", "aria-owns": this.menuId });
				},
				_destroy: function () {
					this.options.nativeMenu ||
						(this.close(),
						this._origTabIndex !== b &&
							(this._origTabIndex !== !1 ? this.select.attr("tabindex", this._origTabIndex) : this.select.removeAttr("tabindex")),
						...
						_enhance: function () {
							...
							return (
								d.groupLegend.length > 0 &&
									a("<div role='heading' class='ui-controlgroup-label'></div>").append(d.groupLegend).prependTo(b),
								d
							);
						},
						_init: function () {
							...
							return (
								a.type !== b &&
									(e
										...
										.addClass("ui-controlgroup-" + ("horizontal" === a.type ? "horizontal" : "vertical")),
									(c = !0)),
								a.theme !== b &&
									e.removeClass(this._themeClassFromOption(this.options.theme)).addClass(this._themeClassFromOption(a.theme)),
		...
		(function (a, b) {
			a.widget("mobile.toolbar", a.mobile.toolbar, {
				...
				_setOptions: function (c) {
					if (
						("fixed" === c.position && "fixed" !== this.options.position && this._makeFixed(),
				...
				_addTransitionClass: function () {
					...
					a &&
						"none" !== a &&
						("slide" === a && (a = this.element.hasClass("ui-header") ? "slidedown" : "slideup"), this.element.addClass(a));
				},
				...
				_handlePageShow: function () {
					this.updatePagePadding(this.page ? this.page : ".ui-page-active"),
						this.options.updatePagePadding && this._on(this.window, { throttledresize: "updatePagePadding" });
				},
					...
					return (
						...
						((this.options.transition &&
							...
							(("header" === this.role && !this.options.fullscreen && e > f) ||
								("footer" === this.role && !this.options.fullscreen && g - f > e + h))) ||
							this.options.fullscreen)
					);
				},
				show: function (a) {
				...
				_tryAnArrow: function (a, b, c, d, e) {
					...
					return d.arFull[a.dimKey] > d.guideDims[a.dimKey]
						...
						: ((i[a.fst] =
								...
								d.contentBox[a.fst] +
								(d.clampInfo.menuSize[a.oDimKey] - d.contentBox[a.oDimKey]) * a.arrowOffsetFactor),
						  (i[a.snd] = c[a.snd]),
						  ...
						  (j[a.snd] = Math.max(
								...
								Math.min(f[a.prop] + d.guideOffset[a.prop] + d.guideDims[a.dimKey] - d.arHalf[a.dimKey], c[a.snd])
						  )),
						  (h = Math.abs(c.x - j.x) + Math.abs(c.y - j.y)),
						  (!e || h < e.diff) &&
								((j[a.snd] -= d.arHalf[a.dimKey] + f[a.prop] + d.contentBox[a.snd]),
								(e = { dir: b, diff: h, result: f, posProp: a.prop, posVal: j[a.snd] })),
						  e);
				},
						  ...
						  e
								? (j.ct
								  ...
								  d ||
										...
										(h[f[e.dir].snd] = { left: g.left + c.contentBox.x, top: g.top + c.contentBox.y })),
								  e.result)
			...
			a.widget("mobile.panel", {
				...
				_positionPanel: function (b) {
					...
					e || !c.options.positionFixed
						? (e && (c._unfixPanel(), a.mobile.resetActivePageHeight(d)), b && this.window[0].scrollTo(0, a.mobile.defaultHomeScroll))
						: c._fixPanel();
				},
							...
							e = function () {
								c._off(c.document, "panelclose"),
									...
									a.support.cssTransform3d &&
										d.animate &&
										"overlay" !== d.display &&
										(c._wrapper.addClass(d.classes.animate), c._fixedToolbars().addClass(d.classes.animate)),
									!b && a.support.cssTransform3d && d.animate
										? (c._wrapper || c.element).animationComplete(f, "transition")
										: setTimeout(f, 0),
									d.theme &&
										"overlay" !== d.display &&
										c
							...
							f = function () {
								d.theme &&
									...
									a.support.cssTransform3d &&
										d.animate &&
										"overlay" !== d.display &&
										(c._wrapper.removeClass(d.classes.animate), c._fixedToolbars().removeClass(d.classes.animate)),
									c._fixPanel(),
		...
		(function (a, c) {
			...
			a.widget("mobile.filterable", {
						...
						this._timer && (b.clearTimeout(this._timer), (this._timer = 0)),
							(this._timer = this._delay(function () {
								return this._trigger("beforefilter", null, { input: e }) === !1
									? !1
									: (e[0].setAttribute("data-" + a.mobile.ns + "lastval", c), this._filterItems(c), void (this._timer = 0));
							}, 250));
					}
				},
				...
				_filterItems: function (b) {
					...
					0 === i.length
						? k[j.filterReveal && 0 === b.length ? "addClass" : "removeClass"]("ui-screen-hidden")
				...
				a.widget("mobile.filterable", a.mobile.filterable, {
						...
						return (
							...
							this._widget &&
								...
								"listview" === this._widget.widgetName &&
									((this._widget.options.hideDividers = !0), this._widget.element.listview("refresh"))),
							!!this._widget
						);
					},
					...
					_setInput: function (b) {
						...
						if (!b) {
							...
							(d = !1),
								(b = a("<input data-" + a.mobile.ns + "type='search' placeholder='" + c.filterPlaceholder + "'></input>").jqmData(
			...
			a.widget("ui.tabs", {
				...
				_setOption: function (a, b) {
					return "active" === a
						...
						: (this._super(a, b),
						  "collapsible" === a &&
								(this.element.toggleClass("ui-tabs-collapsible", b), b || this.options.active !== !1 || this._activate(0)),
						...
						this.anchors.each(function (c, e) {
							...
							d(e)
								...
								: ((h = b._tabId(j)),
								  (f = "#" + h),
								  (g = b.element.find(f)),
								  g.length || ((g = b._createPanel(h)), g.insertAfter(b.panels[c - 1] || b.tablist)),
				...
				? ((d = a.mobile.zoom),
				  void a.mobile.document.on("mobileinit", function () {
						a.mobile.iosorientationfixEnabled &&
							a.mobile.window.bind("orientationchange.iosorientationfix", d.enable).bind("devicemotion.iosorientationfix", c);
				  }))
							...
							f.length ||
								...
								f.each(function () {
									...
									c[0].getAttribute("data-" + a.mobile.ns + "url") ||
										c.attr("data-" + a.mobile.ns + "url", c.attr("id") || b.convertUrlToDataUrl(i.pathname + i.search));
								}),
								...
								(a(j).is(":jqmData(role='page')") || a.mobile.path.isPath(h) || h === a.mobile.dialogHashKey)
