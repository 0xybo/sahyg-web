$(() => (SAHYG.Instances.settings = new Settings()));
	...
	async save() {
		...
		for (let [key, value] of Object.entries(this.data)) {
			if (this.dataIsModified(value, this.oldData[key]))
				if (value instanceof Array || typeof value == "string" || value instanceof File || typeof value == "boolean") fd.append(key, value);
					...
					custom.forEach(async ([k, v]) => {
						...
						$("[data-horizontal-tabs-id=share]").append(
							SAHYG.createElement(
								...
								SAHYG.createElement("div", { class: "value" }, SAHYG.createElement("c-boolean", { value: "false" }, SAHYG.createElement("c-boolean-circle")))
							)
						);
					});
				}
