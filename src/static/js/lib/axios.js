!(function (e, t) {
	...
	function W(t, n, r) {
		...
		n = n || new (I || FormData)();
		var o,
			i = (r = B.toFlatObject(r, { metaTokens: !0, dots: !1, indexes: !1 }, !1, function (e, t) {
				...
				if (!B.isUndefined(t)) {
					...
					d.push(t),
						B.forEach(t, function (t, o) {
							!0 === (!(B.isUndefined(t) || null === t) && a.call(n, t, B.isString(o) ? o.trim() : o, r, h)) &&
								e(t, r ? r.concat(o) : [o]);
						}),
						d.pop();
				}
	...
	var Q,
		...
		te = FormData,
		ne =
			("undefined" == typeof navigator || ("ReactNative" !== (Q = navigator.product) && "NativeScript" !== Q && "NS" !== Q)) &&
		...
		xhr:
			...
			function (e) {
				return new Promise(function (t, n) {
					...
					if (
						(u.open(e.method.toUpperCase(), X(l, e.params, e.paramsSerializer), !0),
						(u.timeout = e.timeout),
						"onloadend" in u
							? (u.onloadend = d)
	...
	Ce.transitional = function (e, t, n) {
		...
		return function (n, o, i) {
			...
			return (
				t && !Pe[o] && ((Pe[o] = !0), console.warn(r(o, " has been deprecated since v" + t + " and will be removed in the near future"))),
				!e || e(n, o, i)
			);
		};
	};
				...
				r(e, [
					{
						...
						value: function (e, t) {
							...
							void 0 !== o &&
								...
								void 0 !== i && ke.assertOptions(i, { encode: Ue.function, serialize: Ue.function }, !0),
								(t.method = (t.method || this.defaults.method || "get").toLowerCase()),
								(n = a && B.merge(a.common, a[t.method])) &&
									B.forEach(["delete", "get", "head", "post", "put", "patch", "common"], function (e) {
										delete a[e];
									}),
							...
							if (!u) {
								...
								for (h.unshift.apply(h, s), h.push.apply(h, f), l = h.length, c = Promise.resolve(t); d < l; )
									c = c.then(h[d++], h[d++]);
								return c;
							}
							l = s.length;
