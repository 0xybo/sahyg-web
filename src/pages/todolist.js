...
class TodoList extends Page {
	constructor(/** @type {import('../../index')} */ Web) {
		...
		this.setPost(["/todolist/list_color", "/user/:user/todolist/list_color"], this.setListColor.bind(this));
		this.setPost(["/todolist/list_icon", "/user/:user/todolist/list_icon"], this.setListIcon.bind(this));
